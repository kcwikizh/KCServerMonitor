...
import moe.kcwiki.compressor.ZipCompressor;
            ...
            public void run() {
                ...
                try {
                    if(MainServer.isDebugMode()){
                        ...
                        new moe.kcwiki.makeluadata.MakeNewShipData().WriteFile();
                        new moe.kcwiki.makeluadata.MakeNewSlotitemData().WriteFile();
